...
export const metadata: Metadata = {
  title: "OneFix Labs",
  description: "Hair Growth for Men",
  icons: {
    icon: [
      {
  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className={`${inter.className} bg-black bg-dotted-grid`}>
        ...
        <noscript>
          <img height="1" width="1" style={{display: 'none'}} src="https://www.facebook.com/tr?id=703037149317119&ev=PageView&noscript=1" />
          <img height="1" width="1" style={{display: 'none'}} src="https://www.facebook.com/tr?id=746886027994806&ev=PageView&noscript=1" />
        </noscript>
